 ...
 * @param  {boolean} shouldNotTransmit} if set to true, would not transmit to corresponding subscribed events
 */
export function StoreEvent({ eventName, data, objParams, isMemoryStore, shouldNotTransmit = false }) {
